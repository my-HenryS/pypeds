...
if __name__ == "__main__":
    ...
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(19.5, 26), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(20.5, 26.5), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(19.5, 27), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(20.5, 27.5), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(19.5, 28), 0.45 / 2, 0.25 / 2, math.pi)))

    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(21.5, 26), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(22.5, 26.5), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(21.5, 27), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(22.5, 27.5), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(21.5, 28), 0.45 / 2, 0.25 / 2, math.pi)))

    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(23.5, 26), 0.45 / 2, 0.25 / 2, math.pi)))
    scene.add_entity(RotatePedestrian(Ellipse2D(Point2D(24.5, 26.5), 0.45 / 2, 0.25 / 2, math.pi)))
